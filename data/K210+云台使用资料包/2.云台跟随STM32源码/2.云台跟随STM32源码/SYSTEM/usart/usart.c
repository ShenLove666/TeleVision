...
void uart1_callback(u8 recv)
{
	if( recv=='A' ) Target1+=10;
	else if( recv=='a' ) Target1 -= 10; //云台
	
	else if( recv=='B' ) Target2+=10; //顶部
	else if( recv=='b' ) Target2-=10;
}
